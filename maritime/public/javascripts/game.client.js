...
function saved() {
  document.querySelector("#saved").style =
    "text-align: center; border: 1px solid #c3e6cb; background-color: #d4edda; border-radius: .25rem; opacity:100;";
  setTimeout(function() {
    document.querySelector("#saved").style =
      "text-align: center; border: 1px solid #c3e6cb; background-color: #d4edda; border-radius: .25rem; opacity:0;-moz-transition: opacity 2s ease-in-out;";
  }, 1);
}
...
function init() {
  ...
  socket.on("itemMissing", function(msg, item) {
    document.querySelector("#" + msg).innerHTML =
      '<a href="bol.jpg">View Image</a><br>Missing items:';
